...
import com.example.gamehubmobile.flappybird.Bird;
import com.example.gamehubmobile.flappybird.Constants;
import com.example.gamehubmobile.flappybird.Pipe;

import java.util.ArrayList;

public class GameViewFlappyBird extends View {
    private Bird bird;
    ...
    public void reset() {
        StartFlappyBirds.txt_score.setText("0");
        score=0;
        initPipe();
        initBird();
    }
